...
# здесь указываете свой путь, в котором загружены файлы .xml из CascadeClassifier. Данные файлы доступны в репозитории OpenCV
...
for root, dirs, files in os.walk(image_dir):
    for file in files:
        if file.endswith("png") or file.endswith("jpg"):
            ...
            image_array = np.array(pil_image, "uint8")   # final_image
            print(image_array)
